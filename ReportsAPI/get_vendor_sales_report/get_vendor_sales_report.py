...
if report_id == None:
    ...
    report_file_path = f'./reports-downloaded/start-{data_start_time}-end-{data_end_time}-id-{report_id}-period-{report_period}-dist-{distributor_view}-program-{selling_program}.json'
