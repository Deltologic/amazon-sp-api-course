...
"""
data_start_time = "2024-07-07T00:00:00Z"
data_end_time = "2024-07-13T00:00:00Z"
...
marketplace_id = Marketplaces.FR.marketplace_id
...
report_type = ReportType.GET_BRAND_ANALYTICS_SEARCH_TERMS_REPORT.value
...
if report_id == None:
    ...
    report_file_path = f'./reports-downloaded/start-{data_start_time}-end-{data_end_time}-id-{report_id}-date_gran-{report_period}.json'
    ...
    # processing the report (huge json)
    ...
    data_by_department_and_search_term_key = 'dataByDepartmentAndSearchTerm'
    count = 0
