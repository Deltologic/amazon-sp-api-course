...
SECRET_KEY = 'django-insecure-!(uljlyzh*v85mrsapzc@lb4e^!ytm7lfp7#ug%fi#4woy$jq('
...
CSRF_TRUSTED_ORIGINS = ["https://#######.ngrok-free.app", ]  # To replace it here!

AMAZON_LWA_SOLUTION_ID = os.getenv('AMAZON_LWA_SOLUTION_ID', '')
